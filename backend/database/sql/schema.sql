...
CREATE TABLE IF NOT EXISTS "User" (
  ...
  joined_events TEXT,
  joined_organizations TEXT,
  donor_certificate INT 
);


CREATE TABLE IF NOT EXISTS DonorCard (
    ...
    leukocytes BOOLEAN,
    cant_donate BOOLEAN,
    cant_donate_disqualification BOOLEAN,
    cant_donate_surgery BOOLEAN,
    cant_donate_lactation BOOLEAN,
    cant_donate_other BOOLEAN,
    cant_donate_donor BOOLEAN,
    cant_donate_notice DATE,
    bone_donor BOOLEAN,
    donations_before_reg INTEGER CHECK (donations_before_reg >= 0 AND donations_before_reg <= 999),
    donor_status INTEGER
);

CREATE TABLE IF NOT EXISTS DonationCreate (
    id SERIAL PRIMARY KEY,
    blood_station_id INTEGER,
    image_id INTEGER,
    ...
    payment_cost DOUBLE PRECISION,
    on_moderation_date DATE,
    with_image BOOLEAN,
...
CREATE TABLE IF NOT EXISTS DonationDetail (
    ...
    allowed_modify TEXT,
    feedback TEXT,
    favorite_blood_station_id TEXT,
    created_at TIMESTAMP WITH TIME ZONE NOT NULL,
    updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
    status TEXT NOT NULL,
    reject_reason TEXT,
